...
def validate_config(config):
    ...
    # Base model setting
    assert config['base_model_setting']['model_type'] in ['azureopenai', 'openai', 'palm', 'hf_text2text', 'hf_textgeneration', 'ct_model', 'vllm'], \
        "base_model.model_type must be one of 'azureopenai', 'openai', 'palm', 'hf_text2text', 'hf_textgeneration', 'ct_model' and 'vllm' "
    ...
    # Optim model setting
    assert config['optim_model_setting']['model_type'] in ['azureopenai', 'openai', 'palm', 'hf_text2text', 'hf_textgeneration', 'ct_model'], \
        "optim_model.model_type must be one of 'azureopenai', 'openai', 'palm', 'hf_text2text', 'hf_textgeneration', 'ct_model' and 'vllm' "
